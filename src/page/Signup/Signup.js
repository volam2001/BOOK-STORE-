      ...
      <div className="mx-[200px] flex justify-between ">
        ...
        <div className="w-[400px] h-[430px] bg-white mt-[20px]">
          <div className="mx-[32px] my-[35px]">
            ...
            <input
              className="pl-[10px] mb-[33px] h-[40px] bg-[#e2e8f0] border-[1px] border-neutral-300 outline-none w-full "
              type="text"
            ...
            <br></br>
            <button
              className="bg-[#04AA6D] text-center text-white w-full mb-[20px] h-[43px] "
              type="submit"
            >
              Tiếp theo
            </button>
