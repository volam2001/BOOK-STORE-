    ...
    <div className="mb-[100px]">
      <div className="flex h-[100px] items-center justify-between shadow-lg">
        <div className="ml-[90px]">
          ...
          <span className="text-[25px] text-[#EE4D2D] mr-[15px] font-medium pr-[15px]  border-r-[1px] border-r-[#EE4D2D]">
            Dinobook
          </span>
      ...
      <div className="bg-[#F5F5F5] h-auto   ">
        <div className="  h-[42px] mx-[76px]  bg-white flex items-center border-[1px] border-[#F3DB97] mt-[20px] ">
          <img
            className="w-[26px] h-[20px] mx-[10px]"
        ...
        <div className="h-[62px] mx-[76px]  bg-white mt-[15px] shadow-lg flex justify-between px-[40px] items-center border-[1px] border-b-[#E8E8E8] ">
          <div>
            <input type="checkbox" />
            <span className="ml-[20px] bg-[#EE4D2D] w-[70px] h-[15px] rounded-sm text-center px-[5px] text-white cursor-pointer text-[13px]">
              Yêu Thích+
            </span>
              ...
              <div key={item.id} className="flex my-[20px]">
                ...
                <div className="ml-[20px] flex items-center  ">
                  <div className="  flex items-center justify-center ">
                    <img className="w-[80px] h-[80px]" src={item.url} alt="" />
                    <div className="ml-[10px]">
                      <p className="w-[280px]">{item.name}</p>
                      <button className="border-[1px] border-[#EE4D2D] text-[10px] w-[68px] h-[20px] text-red-500 rounded-sm">
                        Special Price
                      </button>
                    </div>
                    <span className="  opacity-70 ml-[30px] ">
                      Phân loại hàng:
                    </span>
                  </div>
                  ...
                  <div className="ml-[100px] flex items-center">
                    ...
                    <span className="text-red-500 mr-[60px]">
                      {count * 120000}đ{" "}
                    </span>
                    <i
        ...
        <div className="h-[62px] mx-[76px]  bg-white flex items-center border-[1.5px] border-[#E8E8E8]  ">
          ...
          />
          <span>
            Giảm ₫40.000 phí vận chuyển đơn tối thiểu 0đ{" "}
            <span className="text-blue-900">Tìm hiểu thêm</span>
          </span>
        </div>
        ...
        <div className="h-[62px] mx-[76px] bg-white mt-[10px] shadow-lg flex justify-between items-center px-[40px] border-[1px] border-b-[#E8E8E8] ] ">
          ...
          <div>
            <span className="mr-[20px]">
              Tổng thanh toán ({cartItem.length} Sản phẩm):
              <span className="text-red-500 text-[20px]"> 0đ</span>
            </span>
            <button className="w-[210px] h-[40px] bg-[#F05D40] text-white">
              Mua hàng
            </button>
          </div>
        </div>
